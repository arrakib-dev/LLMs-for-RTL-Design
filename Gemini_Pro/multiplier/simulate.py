...
# os.system('ghdl -i -g -Wno-hide -O3 -fsynopsys --workdir=work *.vhd')
# os.system('ghdl -m -g -Wno-hide -O3 -fsynopsys --workdir=work ' + top)

# os.system('ghdl -r -g -Wno-hide -O3 -fsynopsys --workdir=work ' + top + param + ' --wave=work/' + top + '.ghw' + ' --vcd=work/' + top + '.vcd' +' --stop-time=' + stoptime + ' --ieee-asserts=disable') 
